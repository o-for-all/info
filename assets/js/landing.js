...
if ($('.mission-carousel')) {
  $('.mission-carousel').slick({
    ...
    pauseOnHover: true,
    infinite: true,
    prevArrow: '<button type="button" class="slick-nav-btn"><img src="assets/images/Arrow_R@2x.svg"></button>',
    nextArrow: '<button type="button" class="slick-nav-btn"><img src="assets/images/Arrow_L@2x.svg"></button>',
